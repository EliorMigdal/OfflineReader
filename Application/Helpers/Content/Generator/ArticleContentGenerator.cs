...
public class ArticleContentGenerator
{
    ...
    private void addArticleTitle(StackLayout io_StackLayout, InnerArticle i_Article)
    {
    ...
    private void addArticleDescription(StackLayout io_StackLayout, InnerArticle i_Article)
    {
    ...
    private void addArticleAuthor(StackLayout io_StackLayout, InnerArticle i_Article)
    {
        ...
        if (!i_Article.Author.ImageSource.Equals(string.Empty))
        {
            authorStackLayout.Children.Add(new Image
            {
                Source = i_Article.Author.ImageSource,
    ...
    private void addArticleDates(StackLayout io_StackLayout, InnerArticle i_Article)
    {
        io_StackLayout.Children.Add(new Label
        {
    ...
    private void addArticleBody(StackLayout io_StackLayout, InnerArticle i_Article)
    {
        foreach (BodyContent bodyContent in i_Article.BodyContents)
        {
